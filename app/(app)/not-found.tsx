...
export default function NotFound() {
  return (
    <div className={PAGE_FRAME.focused}>
      <h1 className="text-2xl font-medium tracking-[-0.01em]">Nothing here</h1>
      <p className="mt-2 text-[15px] text-muted-foreground">This page has moved or never existed.</p>
